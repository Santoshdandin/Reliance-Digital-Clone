...
import { HomeIcon, ChevronRightIcon } from "@chakra-ui/icons";
...
<Flex  gap="8px">
  <Box w='300px' h="full" ml="8px" bg="#FFFFFF" boxShadow="xs" pt="20px" px="16px">
    ...
    <Box  py="16px" >
    <Heading as="h4" fontSize="14px" my="10px"  fontWeight="400"  color="#5a5a59" fontWeight="bold">Price</Heading>
...
<Flex alignItems="center" gap="2">
  ...
  <Button bg="#003380" borderRadius="0" color="white">Go</Button>
    ...
    <Box  py="16px">
    <Heading as="h4" fontSize="14px" my="10px"  fontWeight="400"  color="#5a5a59" fontWeight="bold">Availability</Heading>
    ...
    <Box  py="16px">
    <Heading as="h4" fontSize="14px" my="10px"  fontWeight="400"  color="#5a5a59" fontWeight="bold">Brand</Heading>
    ...
    <Box  py="16px">
    <Heading as="h4" fontSize="14px" my="10px"  fontWeight="400"  color="#5a5a59" fontWeight="bold">Discount Percent</Heading>
  ...
  <AccordionItem py="8px">
    <h2>
      <AccordionButton p="0" >
        ...
        <Heading as="h4" fontSize="14px" my="10px"  fontWeight="400"  color="#5a5a59" fontWeight="bold">Features</Heading>
        </Box>
        <AccordionIcon />
      </AccordionButton>
    </h2>
  ...
  <AccordionItem py="8px">
    <h2>
      <AccordionButton p="0" >
        <Box flex='1' textAlign='left' p="0">
        <Heading as="h4" fontSize="14px" my="10px"  fontWeight="400"  color="#5a5a59" fontWeight="bold">Memory RAM</Heading>
        </Box>
        <AccordionIcon />
      </AccordionButton>
    </h2>
  ...
  <AccordionItem py="8px">
    <h2>
      <AccordionButton p="0" >
        <Box flex='1' textAlign='left' p="0">
        <Heading as="h4" fontSize="14px" my="10px"  fontWeight="400"  color="#5a5a59" fontWeight="bold">Primary Camera</Heading>
        </Box>
        <AccordionIcon />
      </AccordionButton>
    </h2>
